...
public class Iterators01 {
 /*
            ...
            "for-each-loop" and "iterators" have same performance but iterators are the best to remove elements to modify elements in a collection
     */
    ...
    public static void main(String[] args) {
        ...
        // Ali    Can    Aliye
        while(itr.hasNext()){ //hasNext() method will ask the pointer if there is any next element or not.
            String el = itr.next(); //next() method will take the element and move the pointer to the next element
            itr.set(el + "*");
        }
        System.out.println(list1);
