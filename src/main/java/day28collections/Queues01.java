...
public class Queues01 {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        String el8 = emptyWareHouse.remove();//NoSuchElementException hatasını vercek
        System.out.println(el8);


        /*
        A. The remove() and poll() methods both remove and return the head of the queue.

        B. Both element() and peek() methods return the head of the queue without removing.

        C. If the queue is empty, element() throws "NoSuchElementException", while peek() returns null.

        D. If the queue is empty, remove() throws"NoSuchElementException", while poll() returns null.
         */
    }
}
