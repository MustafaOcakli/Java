...
public class Teacher {
  /*
        ...
        7)Why do we need "Method Overloading"? To make your application well organized (replace(-),replace(-,-))

        Note: Method Overloading + Method Overriding = Polymorphism
        You are creating same name methods in multiple forms thats why we are calling Polymorphism
    */
