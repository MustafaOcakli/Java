...
public class MultiDimensionalArrays01 {
    public static void main(String[] args) {
        ...
        //If an array has arrays elements it is called "multidimensional array"
        ...
        System.out.println(Arrays.deepToString(brr)); //[[Tom, Jim], [Angie], [Carl, Chris, Ali]] Bu şekilde dimensionalları istediğim miktarda yapabilirsin
