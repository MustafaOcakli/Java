...
public class HashMap03 {
    public static void main(String[] args) {
        ...
        //Example 1: Type code to print the number of occurrences of words in a sentence              ****(Interview)!!!****
        //"I like to move it, move it do you like it?"  => I=1, like=2, to=1, move=2, it=3, do=1, you=1 (Map yapısı)
