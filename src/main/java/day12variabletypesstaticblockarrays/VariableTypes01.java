...
public class VariableTypes01 {
    ...
    //Note: Local vaariables can be used just inside the method
    //If you try to use it outside the method it will give error

    //Note: If the return typr is diggerent from "void" you have to use "return" keyword inside the method

    //Note: When you create a method use the "return" keyword in the last line.
    //You cannot type any codes after return keyword
