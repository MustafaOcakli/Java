...
public class StaticBlock01 {
    ...
    /*
        ...
        5) "static block" can be used just with "static" variables, because of the rule i 4th step
        6)"static block" is used to initialize(assigning first value) "static variables"
        7) When we create a variable inside the main method, we do not use "static" keyword, because Java knows
