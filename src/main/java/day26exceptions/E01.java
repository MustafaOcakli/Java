...
public class E01 {
    ...
    public static void printAge(int age){// When you create a method, you use "variables" inside the method parenthesis, they are called "parameters"
        if(age<0){
            throw new IllegalArgumentException("Age cannot be negative"); //Java does not know age can not be negative because its something from our daily life.
                                                                          //For your daily life rules if you wanna create exception you can use that syntax.
        }
