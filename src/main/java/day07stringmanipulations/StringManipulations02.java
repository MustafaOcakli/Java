...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        String result1 = str.replace('O', '*'); //Java is **P (O gördüğü yeri siler yerine * koyar. (char kullanılır)
        System.out.println(result1);


        String result2 = str.replace("Java","*"); //string kullanabilirsin
        ...
        boolean secondRule = pwd.replaceAll("[a-zA-Z0-9 ]","").length()>0; //9 un yanında boşluk var
